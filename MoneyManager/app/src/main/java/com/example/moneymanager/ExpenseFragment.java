...
public class ExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        totalExpenseTV = view.findViewById(R.id.expenseResultText);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void sDescription(String description) {
            TextView descTV = view1.findViewById(R.id.expDescT);
            descTV.setText(description);
        }

        private void sCategory(String category) {
            TextView catTV = view1.findViewById(R.id.expCategoryT);
            catTV.setText(category);
        }

        private void sAmount(double amount) {
            TextView amountTV = view1.findViewById(R.id.expAmountT);
            String amountS = String.valueOf(amount);
            amountTV.setText(amountS);
        }

        private void sDate(String date) {
            TextView dateTV = view1.findViewById(R.id.expDateT);
            dateTV.setText(date);
        }
    }
    ...
    private void modifyData() {
        ...
        ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(getContext(),R.array.category
        ...
        modifyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                expenseRef.child(key).setValue(data);
